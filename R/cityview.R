...
cityview <- function(name = NULL,
                     zoom = 1,
                     theme = c("vintage", "modern", "bright", "delftware", "comic", "rouge", "original", "midearth", "batik", "vice", "grey", "bw", "wb", "bw_black", "wb_black", "wb_blue", "blond1", "blond2", "blond3", "peach", "auburn", "minimal_green", "minimal_green_invert", "blues", "darkmint", "prism", "prism2", "sepia1"),
