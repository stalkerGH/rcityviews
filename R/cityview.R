...
cityview <- function(name = NULL,
                     zoom = 1,
                     theme = c("grey", "grey_blue", "grey_blue2", "grey_blue3", "blue", "bw", "wb", "bw_black", "wb_black", "blond1", "blond2", "blond3", "minimal_green", "minimal_green_invert", "darkmint", "prism", "prism2", "wb_blue", "wb_blue2", "wb_blue3", "wb_red", "wb_alpha", "sepia1"),
